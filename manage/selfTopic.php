				...
				<div class="span12 mainContent">
					<div class="selfManageMenu">	
						...
						<ul class="nav nav-tabs pull-right">
							<li>
								<button id="createBtn" class="btn-link">新建话题</a>
							</li>
						</ul>
					</div>
				...
				<div class="span12 mainContent">
					<div class="row-fluid ">
						<div class="form-horizontal registerForm">
							<div class="formTitle">
								<legend>写话题</legend>
								<button class="btn-link pull-right listBtn">返回话题列表</button>
							</div>
						  	...
						  	<div class="control-group">
						    	...
						    	<div class="controls">
							      	<textarea id="inputTopicContent" placeholder="最多200字"></textarea>
							    </div>
						  	</div>
							
							<!--下面是关于超文本编辑器的部分-->
							<div class="control-group">
								<label class="control-label" for="inputDescription">话题详情(最多1K字)</label>
								<div class="controls">
									<div class="editorDiv">
										<div id="alerts"></div>
							...
							<div class="control-group">
							    <div class="controls">
							      	<button type="submit" class="btn btn-info" id="createTopicBtn">创建话题</button>
