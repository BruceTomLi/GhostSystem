<?php
	...
	class SystemManager extends User{
		...
		function changeSystemSettingInfo($maxQuestion=20,$maxTopic=20,$maxArticle=20,
					$maxComment=100,$maxFindPassword=5,$maxVisitPerMinute=100){
			global $pdo;
			...
			$sql="call pro_UpdateSomeSystemSetting(:maxQuestion,:maxTopic,:maxArticle,:maxComment,:maxFindPassword,:maxVisitPerMinute,@outUpdateRow);";
